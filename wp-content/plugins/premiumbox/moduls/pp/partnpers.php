...
if(is_admin()){
	add_action('pn_adminpage_title_pn_partnpers', 'def_adminpage_title_pn_partnpers');
	function def_adminpage_title_pn_partnpers(){
		_e('Royalties','pn');
	}

	add_action('pn_adminpage_content_pn_partnpers','def_pn_adminpage_content_pn_partnpers');
	function def_pn_adminpage_content_pn_partnpers(){
		premium_table_list();
	}
